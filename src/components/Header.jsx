...
import horizontalLogo from '../assets/images/DSCBPDCOnlyLogo.svg'
                ...
                <BrowserView>
                    <div className="header-options">
                        <ul>
                            ...
                            <li><Link to="/blogs" className="link">Resources</Link></li>
                ...
                <div className="mobile-menu" style={{visibility: this.state.menuOpen ? '' : 'hidden', paddingTop: 70, height: this.state.menuOpen ? '100vh' : 0, overflow:'hidden'}}>
                    <div className="header-options">
                        <ul>
                            ...
                            <li onClick={() => this.setState({menuOpen: !this.state.menuOpen})}><Link to="/blogs" className="link">Resources</Link></li>
