...
class Contact extends React.Component {
  ...
  handleSubmit = async (e) => {
    const url = "https://script.google.com/macros/s/AKfycbxBe1WTrUR38Ye4cODJ7Cg1HSvhrebUCwba6OB-pPSwIF45jk0au2s38mx6t8X50m1YJw/exec";
    const data = {
